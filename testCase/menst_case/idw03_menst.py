...
class gt02_menst:
    ...
    def test_menst(self):
        ...
        for i in range(len(case_list)):
            ...
            # 执行用例
            self.menst_caseNO1(case_list[i])
            time.sleep(3)
...
if __name__ == '__main__':
    # yamlpath = filePath.menstPara
    # # menst_yaml = readYaml(filePath.menstPara)
    # # off_on = menst_yaml['initial']['off_on']
    # # print(off_on)
    # # # MenstCmd.menses_set_cmd()
    # gt02_menst().stop_go_menst_ui()
    # print(readYaml(filePath.watch_cmd)['gt02']['start_sotp'])
